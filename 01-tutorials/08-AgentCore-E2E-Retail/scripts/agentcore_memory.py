...
def cli(ctx):
    ...
    Create and delete AgentCore memory resources for the retail application.
    """
...
@cli.command()
@click.option(
    "--name", default="RetailMemory", help="Name of the memory resource"
)
@click.option(
    "--ssm-param",
    default="/app/retail/agentcore/memory_id",
...
def create(name, ssm_param, event_expiry_days):
    ...
    strategies = [
        {
            StrategyType.SEMANTIC.value: {
                ...
                "namespaces": ["retail/user/{actorId}/facts"],
            },
        },
        {
            StrategyType.SUMMARY.value: {
                ...
                "namespaces": ["retail/user/{actorId}/{sessionId}"],
            },
        },
        {
            StrategyType.USER_PREFERENCE.value: {
                ...
                "namespaces": ["retail/user/{actorId}/preferences"],
            },
        },
    ]
    ...
    try:
        ...
        memory = memory_client.create_memory_and_wait(
            ...
            description="Memory for retail agent",
