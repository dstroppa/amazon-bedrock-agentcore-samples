...
def store_provider_name_in_ssm(provider_name: str):
    ...
    param_name = "/app/retail/agentcore/cognito_provider"
    try:
        ssm.put_parameter(
...
def create_cognito_provider(provider_name: str) -> dict:
    ...
    try:
        ...
        auth_url = get_ssm_parameter("/app/retail/agentcore/cognito_auth_url")
        token_url = get_ssm_parameter(
            "/app/retail/agentcore/cognito_token_url"
        )
