...
from utils import get_ssm_parameter, get_shopping_assistant_secret

secret = get_shopping_assistant_secret()
...
st.title("Shopping Assistant Agent")
...
if prompt := st.chat_input("What is up?"):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            message_placeholder.markdown(f'<span class="thinking-bubble">🤖 💭 Shopping Assistant is thinking...</span>', unsafe_allow_html=True)
